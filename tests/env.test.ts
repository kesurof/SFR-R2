...
const valid = { DATABASE_URL: "file:/tmp/test.db", NEXTAUTH_URL: "http://localhost:3000", AUTH_SECRET: "x".repeat(32), AUTH_DISCORD_ID: "123", AUTH_DISCORD_SECRET: "secret", DISCORD_GUILD_ID: "100000000000000001", ADMIN_DISCORD_IDS: "100000000000000002", ENCRYPTION_KEY: Buffer.alloc(32, 7).toString("base64"), DISCORD_BOT_TOKEN: "token", DISCORD_ACCESS_REQUEST_CHANNEL_ID: "100000000000000003" };
